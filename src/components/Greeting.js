...
function Greeting() {
  ...
  const [group, setGroup]  = useState(['Will', 'Bill', 'Phil']);
    ...
    <div className="card text-center">
      ...
      <div className="card-body">
        ...
        <ul>
          ...
          {group.map((nameOfGroup => <li key={nameOfGroup}>{nameOfGroup}</li>))}
          {/* can do the top or the bottom - top is much more dynamic */}
          <li>{group[0]}</li>
          <li>{group[1]}</li>
          <li>{group[2]}</li>
        </ul>
